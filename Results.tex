...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.8\textwidth]{AnalogResults/psd.pdf}
...
\begin{figure}
    ...
    \begin{subfigure}[ht]{\textwidth}
    	\centering
        \includegraphics[width=0.8\textwidth]{DigitalResults/psd.pdf}
        \caption{}
        \label{fig:psd_d}
    \end{subfigure}
	\begin{subfigure}[ht]{\textwidth}
		\centering
        \includegraphics[width=0.8\textwidth]{DigitalResults/CNNpsd.pdf}
        \caption{}
    	\label{fig:cnn_E} 
    \end{subfigure}
